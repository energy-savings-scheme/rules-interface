...
export default function ActivityRequirementsSYS1(props) {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    clearSearchCaptureAnalytics();
    updateEstimatorFormAnalytics(BASE_COMMERCIAL_MOTOR_ELIGIBILITY_ANALYTICS_DATA);
    updateFeedbackFormAnalytics(BASE_COMMERCIAL_MOTOR_ELIGIBILITY_ANALYTICS_DATA);
  }, [stepNumber]);
          ...
          <div className="nsw-grid nsw-grid--spaced">
            <div className="nsw-col nsw-col-md-12">
              ...
              <p className="nsw-content-block__copy">
                ...
                the Commercial motors activity (F7 in the{' '}
                <a
                ...
                ). This activity is for the new installation or replacement of a high efficiency
                motor.
              </p>
              <p className="nsw-content-block__copy">
