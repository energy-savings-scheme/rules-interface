...
import LoadClausesD20 from './LoadClausesActReq';
...
import {BASE_RESIDENTIAL_GAS_SOLAR_WH_ELIGIBILITY_ANALYTICS_DATA} from 'constant/base-analytics-data';
...
export default function ActivityRequirementsD20(props) {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    clearSearchCaptureAnalytics();
    updateEstimatorFormAnalytics(BASE_RESIDENTIAL_GAS_SOLAR_WH_ELIGIBILITY_ANALYTICS_DATA);
    updateFeedbackFormAnalytics(BASE_RESIDENTIAL_GAS_SOLAR_WH_ELIGIBILITY_ANALYTICS_DATA);
  }, [stepNumber]);
                  ...
                  options={[
                    {
                      ...
                      link: '/#residential-gas-replacement-solar-water-heater-estimator',
                    },
                  ]}
                />
              </div>
