...
import { BASE_COMMERCIAL_GAS_HEAT_PUMP_ESTIMATOR_ANALYTICS_DATA } from 'constant/base-analytics-data';
import {
...
export default function CertificateEstimatorF16_gas(props) {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    updateEstimatorFormAnalytics(BASE_COMMERCIAL_GAS_HEAT_PUMP_ESTIMATOR_ANALYTICS_DATA);
    updateFeedbackFormAnalytics(BASE_COMMERCIAL_GAS_HEAT_PUMP_ESTIMATOR_ANALYTICS_DATA);
  }, []);
                  ...
                  options={[
                    {
                      ...
                      link: '/#commercial-gas-to-heat-pump-water-heater-eligibility',
                    },
                  ]}
                />
              </div>
