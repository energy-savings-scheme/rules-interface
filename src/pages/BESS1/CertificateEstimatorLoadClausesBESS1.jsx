  ...
  useEffect(() => {
    if (variableData1.length == 0) {
      ...
      if (variables.length == 0) {
        ...
        const variable1 = variables.find((item) => item.name === 'BESS1_PDRSAug24_PRC_calculation');
        const variable2 = variables.find((item) => item.name === 'BESS1_PDRSAug24_PRC_calculation');
