...
import CertificateEstimatorLoadClausesWHtest from './CertificateEstimatorLoadClausesWH';

export default function CertificateEstimatorWH2_test(props) {
  ...
  RegistryApi.getCommercialWHLastModified()
    .then((res) => {
  ...
  useEffect(() => {
    const payload = {
      buildings: {
        building_1: {
          WH2_test_PDRS__postcode: { '2023-01-01': postcode },
          WH2_test_get_HP_zone_by_BCA_climate_zone: { '2023-01-01': null },
        },
      },
      persons: {
        person1: {},
    ...
    OpenFiscaApi.postCalculate(payload)
      .then((res) => {
        var result =
          res.data.buildings.building_1['WH2_test_get_HP_zone_by_BCA_climate_zone']['2023-01-01'];
        setZone(result);
        console.log(result);
      })
      .catch((err) => {
          ...
          <div className="nsw-grid nsw-grid--spaced">
            <div className="nsw-col nsw-col-md-10">
              <h2 className="nsw-content-block__title">
                Commercial Heat Pump Water Heater certificate estimator (Experimental)
              </h2>
              <br></br>
