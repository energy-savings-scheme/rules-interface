...
export default function ActivityRequirementsD19(props) {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    clearSearchCaptureAnalytics();
    updateEstimatorFormAnalytics(BASE_RESIDENTIAL_GAS_HEAT_PUMP_ELIGIBILITY_ANALYTICS_DATA);
    updateFeedbackFormAnalytics(BASE_RESIDENTIAL_GAS_HEAT_PUMP_ELIGIBILITY_ANALYTICS_DATA);
  }, [stepNumber]);
          ...
          <div className="nsw-grid nsw-grid--spaced">
            <div className="nsw-col nsw-col-md-12">
              {/* <h2 className="nsw-content-block__title">
                Gas heat pump water heater activity eligibility check
              </h2> */}
              <br></br>
