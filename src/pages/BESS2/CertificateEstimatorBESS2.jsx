        ...
        {stepNumber !== 2 && (
          <div className="nsw-grid nsw-grid--spaced">
            <div className="nsw-col nsw-col-md-10">
              ...
              Answer the following questions to estimate the peak reduction certificates (PRCs) for the residential solar battery activity (BESS2 in the{' '}
                <a
                ...
                ). This activity is for the signup of a 'behind the meter' residential solar battery to a demand response contract. A key requirement of this activity is that there is already a solar PV system installed at the address.
                <p className="nsw-content-block__copy">
              ...
              <p className="nsw-content-block__copy">A battery register for this activity is currently under development. Once the registry is implemented, battery specifications will be automatically updated at the end of each week based on brand and model.</p>
              <p className="nsw-content-block__copy">
