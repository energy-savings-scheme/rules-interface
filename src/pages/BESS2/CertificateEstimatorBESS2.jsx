          ...
          <div className="nsw-grid nsw-grid--spaced">
            <div className="nsw-col nsw-col-md-10">
              ...
              Answer the following questions to estimate the peak reduction certificates (PRCs) for the residential solar battery activity (BESS2 in the{' '}
                ...
                ). This activity is for the signup of a 'behind the meter' residential solar battery to a demand response contract, often called a virtual power plant (VPP). A key requirement of this activity is that there is already a solar PV system installed at the address.
                <p className="nsw-content-block__copy">
