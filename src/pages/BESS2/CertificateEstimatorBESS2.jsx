...
import CertificateEstimatorLoadClausesD18 from './CertificateEstimatorLoadClausesBESS2';
...
export default function CertificateEstimatorBESS2(props) {
  ...
  useEffect(() => {
    ...
    resSolarBatteryBrands.forEach((item) => populateDropDown({ text: item, value: item }));
  ...
  //     buildings: {
  //       building_1: {
  //         BESS1_PDRS__postcode: { '2023-01-01': postcode },
        ...
        {stepNumber !== 3 && (
          <div className="nsw-grid nsw-grid--spaced">
            <div className="nsw-col nsw-col-md-10">
              ...
              <p className="nsw-content-block__copy">
                Where possible, residential solar battery specifications are automatically updated
                at the end of each week from the{' '}
                <a
                  href="https://www.cleanenergycouncil.org.au/industry/products/batteries/approved-batteries"
                  target="_blank"
                >
                  Clean Energy Council approved batteries list
                </a>{' '}
        ...
        <Fragment>
              ...
              <div className="nsw-col" style={{ padding: 'inherit' }}>
                <div className="nsw-content-block">
                  ...
                  <div className="nsw-content-block__content">
                    ...
                    <FormGroup
                      label="Brand"
                      helper="Select residential solar battery brand" // primary question text
                      errorText="Invalid value!" // error text if invalid
                    >
                      <Select
                        style={{ maxWidth: '50%' }}
                    ...
                    <FormGroup
                      label="Model"
                      helper="Select residential solar battery model" // primary question text
                      errorText="Invalid value!" // error text if invalid
                    >
                      <Select
                        style={{ maxWidth: '50%' }}
          ...
          {stepNumber === 2 && (
            <CertificateEstimatorLoadClausesD18
              variableToLoad1={'BESS2_PRC_calculation'}
              variableToLoad2={'BESS2_PRC_calculation'}
              peakDemandReductionSavings={'BESS2_peak_demand_annual_savings'}
