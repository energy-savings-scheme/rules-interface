...
export default function CertificateEstimatorResidentialSolarWaterHeater(props) {
  ...
  useEffect(() => {
    const payload = {
      buildings: {
        building_1: {
          D18_ESSJun24_PDRS__postcode: { '2023-01-01': postcode },
          D18_ESSJun24_get_HP_zone_by_BCA_climate_zone: { '2023-01-01': null },
        },
      },
      persons: {
        person1: {},
    ...
    OpenFiscaApi.postCalculate(payload)
      .then((res) => {
        var result =
          res.data.buildings.building_1['D18_ESSJun24_get_HP_zone_by_BCA_climate_zone']['2023-01-01'];
        setZone(result);
        console.log(result);
      })
      .catch((err) => {
          ...
          <div className="nsw-grid nsw-grid--spaced">
            <div className="nsw-col nsw-col-md-10">
              ...
              <p className="nsw-content-block__copy">
                ...
                business solar water heater activity (D18 in the{' '}
                <a
        ...
        <Fragment>
          ...
          {stepNumber === 3 && (
            <CertificateEstimatorLoadClausesD18
              ...
              annualEnergySavings={'DD18_ESSJun24_annual_energy_savings'}
              peakDemandReductionSavings={'D18_ESSJun24_annual_energy_savings'}
              annualEnergySavingsNumber={annualEnergySavingsNumber}
              setAnnualEnergySavingsNumber={setAnnualEnergySavingsNumber}
              peakDemandReductionSavingsNumber={peakDemandReductionSavingsNumber}
