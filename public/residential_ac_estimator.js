    ...
    62: function (e, t, n) {
      ...
      var k = {
        getCommercialHVACBrands: function () {
          return E({ url: '/commercial_hvac/brands', method: 'GET' });
        },
        getCommercialHVACLastModified: function () {
          return E({ url: '/commercial_hvac/last_modified', method: 'GET' });
        },
        getCommercialWHBrands: function () {
          return E({ url: '/commercial_wh/brands', method: 'GET' });
        },
        getCommercialWHLastModified: function () {
          return E({ url: '/commercial_wh/last_modified', method: 'GET' });
        },
        listHvacModels: function (e) {
          return E({ url: '/commercial_hvac/brands/'.concat(e, '/models'), method: 'GET' });
        },
        getHvacModelsMetadata: function (e) {
          return E({ url: '/commercial_hvac/metadata', method: 'POST', data: e });
        },
        listWHModels: function (e) {
          return E({ url: '/commercial_wh/brands/'.concat(e, '/models'), method: 'GET' });
        },
        getWHModelsMetadata: function (e) {
          return E({ url: '/commercial_wh/metadata', method: 'POST', data: e });
        },
        getRF2LastModified: function () {
          return E({ url: '/refrigerated_cabinets/last_modified', method: 'GET' });
        },
        getRF2Brands: function () {
          return E({ url: '/refrigerated_cabinets/brands', method: 'GET' });
        },
        listRF2Models: function (e) {
          return E({ url: '/refrigerated_cabinets/brands/'.concat(e, '/models'), method: 'GET' });
        },
        getRF2ModelsMetadata: function (e) {
          return E({ url: '/refrigerated_cabinets/metadata', method: 'POST', data: e });
        },
        getPoolPumpBrands: function () {
          return E({ url: '/pool_pumps/brands', method: 'GET' });
        },
        getPoolPumpLastModified: function () {
          return E({ url: '/pool_pumps/last_modified', method: 'GET' });
        },
        listPoolPumpModels: function (e) {
          return E({ url: '/pool_pumps/brands/'.concat(e, '/models'), method: 'GET' });
        },
        getPoolPumpMetadata: function (e) {
          return E({ url: '/pool_pumps/metadata', method: 'POST', data: e });
        },
        getPostcodeValidation: function (e) {
          return E({ url: '/postcode/'.concat(e), method: 'GET' });
        },
        getResidentialHeatPumpLastModified: function () {
          return E({ url: '/residential_heat_pumps/last_modified', method: 'GET' });
        },
        getResidentialHeatPumpBrands: function () {
          return E({ url: '/residential_heat_pumps/brands', method: 'GET' });
        },
        getResidentialHeatPumpModels: function (e) {
          return E({ url: '/residential_heat_pumps/brands/'.concat(e, '/models'), method: 'GET' });
        },
        getResidentialHeatPumpModelsMetadata: function (e) {
          return E({ url: '/residential_heat_pumps/metadata', method: 'POST', data: e });
        },
        getResidentialSolarWaterHeaterLastModified: function () {
          return E({ url: '/residential_solar_water_heater/last_modified', method: 'GET' });
        },
        getResidentialSolarWaterHeaterBrands: function () {
          return E({ url: '/residential_solar_water_heater/brands', method: 'GET' });
        },
        ...
        getResidentialSolarWaterHeaterMetadata: function (e) {
          return E({ url: '/residential_solar_water_heater/metadata', method: 'POST', data: e });
        },
        getResidentialSolarBatteryLastModified: function () {
          return E({ url: '/residential_solar_battery/last_modified', method: 'GET' });
        },
        getResidentialSolarBatteryBrands: function () {
          return E({ url: '/residential_solar_battery/brands', method: 'GET' });
        },
        ...
        getResidentialSolarBatteryMetadata: function (e) {
          return E({ url: '/residential_solar_battery/metadata', method: 'POST', data: e });
        },
      };
      function R(e) {
        var t = e.variable,
          ...
          onSubmit: function (e) {
            ...
            if (n) {
              ...
              V.map(function (e) {
                ...
                console.log('annual energy savings', P),
                p
                  .postCalculate(P)
                  .then(function (e) {
          ...
          Object(s.a)(
            ...
            {},
            {
              children: [
                ...
                l ? Object(v.jsx)(D, { htmlId: n, children: l }) : '',
      ...
      var Oe = ['src', 'className', 'imageAlt'],
        ...
        Ce = function (e) {
          ...
          return Object(v.jsxs)('div', {
            ...
            children: [
              r ? Object(v.jsx)(ye, { src: r, alt: c }) : '',
              l ? Object(v.jsx)(Ne, { children: l }) : '',
              Object(v.jsxs)('div', {
                className: 'nsw-content-block__content',
                children: [
                  a ? Object(v.jsx)(Ae, { children: a }) : '',
      ...
      function Xe(e) {
        var t = e.variableToLoad1,
          ...
          D = e.setAnnualEnergySavingsNumber,
            ...
            function () {
              if (i) {
                ...
                l.map(function (e) {
                  ...
                  console.log(d),
                  d.map(function (e) {
                    'HVAC1_rated_AEER_input' === e.name &&
                      (console.log(e.form_value), (e.form_value = u['Rated AEER'])),
                      'HVAC1_cooling_capacity_input' === e.name &&
                        (e.form_value = u['Cooling Capacity']),
                      'HVAC1_residential_TCEC' === e.name &&
                        (e.form_value = u['Residential tcec_'.concat(S)]),
                      'HVAC1_residential_THEC' === e.name &&
                        (e.form_value = u['Residential thec_'.concat(S)]),
                      'HVAC1_heating_capacity_input' === e.name &&
                        (e.form_value = u['Heating Capacity']),
                      'HVAC1_TCSPF_mixed' === e.name &&
                        (e.form_value = u['Residential TCSPF_mixed']),
                      'HVAC1_HSPF_cold' === e.name && (e.form_value = u['Residential HSPF_cold']),
                      'HVAC1_HSPF_mixed' === e.name && (e.form_value = u['Residential HSPF_mixed']),
                      'HVAC1_input_power' === e.name &&
                        '' != u['Input Power'] &&
                        (e.form_value = u['Input Power']),
                      'HVAC1_rated_ACOP_input' === e.name &&
                        '' != u['Rated ACOP'] &&
                        '-' != u['Rated ACOP'] &&
                        (e.form_value = u['Rated ACOP']),
                      'HVAC1_PDRS__postcode' === e.name && ((e.form_value = x), (e.read_only = !0));
                  }),
                  E.length > 1 &&
                    'backward' === V &&
                    d.map(function (e) {
                      ...
                      Object(v.jsxs)(a.Fragment, {
                        children: [
                          ...
                          Object(v.jsx)(le, {
                            ...
                            setAnnualEnergySavingsNumber: D,
      ...
      function Ze(e) {
        ...
        return (
          Object(a.useEffect)(
            function () {
              A([{ value: '', text: 'Please select model' }]),
          ...
          Object(a.useEffect)(
            function () {
              if (!R) return null;
              if (!I) return null;
              var e = { brand: R, model: I };
              console.log(e),
                k
                  .getHvacModelsMetadata(e)
                  .then(function (e) {
                    Q(e.data);
                  })
                  .catch(function (e) {
          ...
          Object(a.useEffect)(
            function () {
              var e = {
                buildings: {
                  building_1: {
                    HVAC1_PDRS__postcode: { '2021-01-01': he },
              ...
              p
                ...
                .then(function (e) {
                  var t =
                    e.data.buildings.building_1.HVAC1_get_climate_zone_by_postcode['2021-01-01'];
                  Oe(t), console.log(t);
                })
                .catch(function (e) {
                  console.log(e);
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                Object(v.jsxs)('div', {
                                  ...
                                  children: [
                                    ...
                                    Object(v.jsx)(Y, {
                                      label: 'Brand',
                                      helper: 'Select residential air conditioner brand',
                                      errorText: 'Invalid value!',
                                      children: Object(v.jsx)(K, {
                                        style: { maxWidth: '50%' },
                                        options: x,
                                    ...
                                    Object(v.jsx)(Y, {
                                      label: 'Model',
                                      helper: 'Select residential air conditioner model',
                                      errorText: 'Invalid value!',
                                      children: Object(v.jsx)(K, {
                                        style: { maxWidth: '50%' },
                                        options: N,
                                    ...
                                    Object(v.jsxs)('p', {
                                      ...
                                      children: [' ', 'Updated from product registry: ', $e],
                                    }),
                                  ],
                                }),
                              ],
                      ...
                      2 === h &&
                        Object(v.jsx)(Xe, {
                          ...
                          metadata: J,
                          calculationResult: $,
                          calculationResult2: ie,
                          setCalculationResult: ee,
                          setCalculationResult2: re,
                          calculationError: se,
                          ...
                          flow: He,
                          setFlow: Ae,
                          persistFormValues: Ee,
                          setPersistFormValues: ke,
                          loading: Me,
                          setLoading: De,
                          showError: Le,
                          setShowError: We,
                          annualEnergySavingsNumber: at,
                          setAnnualEnergySavingsNumber: it,
                          peakDemandReductionSavingsNumber: lt,
                          setPeakDemandReductionSavingsNumber: st,
                        }),
                      1 === h &&
                        Te &&
                        he.length >= 4 &&
