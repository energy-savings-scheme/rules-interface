...
import dataFixtures from 'cypress/fixtures/eligibility/HVAC2_F4_E.json';

describe('Calculate HVAC2 Eligibility.', () => {
  const urlPath: string = URLPath.HVAC2_F4_E;
  ...
  dataFixtures.forEach((rowData: Record<string, any>) => {
    it(`Successfully calculate commercial ac eligibility with eligible or ineligible result. Test ID: ${rowData['tid']}`, () => {
