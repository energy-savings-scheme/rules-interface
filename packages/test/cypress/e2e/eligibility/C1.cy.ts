...
describe('Calculate C1 Eligibility.', () => {
  ...
  before(() => {
    cy.task<WorkBook>('getDataExcel', EXCEL_PATH).then((workbook) => {
      dataExcel = new DataExcel(workbook, SheetName.C1_E);
  ...
  it('Successfully calculate spare refrigerator eligibility with eligible or ineligible result. Row data 1', () => {
  ...
  it('Successfully calculate spare refrigerator eligibility with eligible or ineligible result. Row data 2', () => {
