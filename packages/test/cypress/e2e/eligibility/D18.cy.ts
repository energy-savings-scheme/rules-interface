...
import dataFixtures from 'cypress/fixtures/eligibility/D18_E.json';
...
describe('Calculate D18 Eligibility.', () => {
  ...
  dataFixtures.forEach((rowData: Record<string, any>) => {
    it(`Successfully calculate electric water heater - solar water heater eligibility with eligible or ineligible result. Test ID: ${rowData['tid']}`, () => {
