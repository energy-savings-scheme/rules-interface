...
import dataFixtures from 'cypress/fixtures/eligibility/F7_E.json';
...
describe('Calculate F7 Eligibility.', () => {
  ...
  dataFixtures.forEach((rowData: Record<string, any>) => {
    it(`Successfully calculate commercial motors eligibility with eligible or ineligible result. Test ID: ${rowData['tid']}`, () => {
