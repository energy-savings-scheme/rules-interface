...
import dataFixtures from 'cypress/fixtures/eligibility/F16_G_E.json';
...
describe('Calculate F16-G Eligibility.', () => {
  ...
  dataFixtures.forEach((rowData: Record<string, any>) => {
    it(`Successfully calculate commercial gas water heater - heat pump eligibility with eligible or ineligible result. Test ID: ${rowData['tid']}`, () => {
