...
describe('Calculate F16-E Eligibility.', () => {
  ...
  before(() => {
    cy.task<WorkBook>('getDataExcel', EXCEL_PATH).then((workbook) => {
      dataExcel = new DataExcel(workbook, SheetName.F16_E_E);
  ...
  it('Successfully calculate commercial electric water heater - heat pump eligibility with eligible or ineligible result. Row data 1', () => {
  ...
  it('Successfully calculate commercial electric water heater - heat pump eligibility with eligible or ineligible result. Row data 2', () => {
  ...
  // it('Successfully calculate commercial electric water heater - heat pump eligibility with eligible or ineligible result.', () => {
