...
import dataFixtures from 'cypress/fixtures/eligibility/C1_E.json';
...
describe('Calculate C1 Eligibility.', () => {
  ...
  dataFixtures.forEach((rowData: Record<string, any>) => {
    it(`Successfully calculate spare refrigerator eligibility with eligible or ineligible result. Test ID: ${rowData['tid']}`, () => {
