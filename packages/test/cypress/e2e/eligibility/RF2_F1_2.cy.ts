...
import dataFixtures from 'cypress/fixtures/eligibility/RF2_F1_2_E.json';
...
describe('Calculate RF2 Eligibility.', () => {
  ...
  dataFixtures.forEach((rowData: Record<string, any>) => {
    it(`Successfully calculate refrigrated cabinet eligibility with eligible or ineligible result. Test ID: ${rowData['tid']}`, () => {
