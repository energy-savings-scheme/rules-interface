...
import dataFixtures from 'cypress/fixtures/eligibility/F17_E.json';
...
describe('Calculate F17 Eligibility.', () => {
  ...
  dataFixtures.forEach((rowData: Record<string, any>) => {
    it(`Successfully calculate commercial new heat pump water-heater eligibility with eligible or ineligible result. Test ID: ${rowData['tid']}`, () => {
