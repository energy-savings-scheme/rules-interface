...
describe('Calculate D17 Eligibility.', () => {
  const urlPath: string = URLPath.D17_E;
  let dataExcel: DataExcel;
  let rowsData: Record<string, any>[];

  before(() => {
    cy.task<WorkBook>('getDataExcel', EXCEL_PATH).then((workbook) => {
      dataExcel = new DataExcel(workbook, SheetName.D17_E);
  ...
  it('Successfully calculate electric water heater - heat pump eligibility with eligible or ineligible result. Row data 1', () => {
  ...
  it('Successfully calculate electric water heater - heat pump eligibility with eligible or ineligible result. Row data 2', () => {
  ...
  it('Successfully calculate electric water heater - heat pump eligibility with eligible or ineligible result. Row data 3', () => {
  ...
  it('Successfully calculate electric water heater - heat pump eligibility with eligible or ineligible result. Row data 4', () => {
  ...
  // it('Successfully calculate electric water heater - heat pump eligibility with eligible or ineligible result.', () => {
