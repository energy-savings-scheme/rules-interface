...
import dataFixtures from 'cypress/fixtures/eligibility/D17_E.json';
...
describe('Calculate D17 Eligibility.', () => {
  ...
  dataFixtures.forEach((rowData: Record<string, any>) => {
    it(`Successfully calculate electric water heater - heat pump eligibility with eligible or ineligible result. Test ID: ${rowData['tid']}`, () => {
