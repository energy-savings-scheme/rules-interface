...
const config: Config = {
  ...
  sendReportToEmail: process.env['SEND_REPORT_TO_EMAIL']?.toLowerCase() === 'true' || false,
  uploadReportToGithub: process.env['UPLOAD_REPORT_TO_GITHUB']?.toLocaleLowerCase() === 'true' || false,
