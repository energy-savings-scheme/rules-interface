...
enum URLPath {
  ...
  BESS2_C = '#/residential-battery-demand-response-certificates',
  BESS3_C = '#/residential-apartments-battery-certificates',
  ...
  BESS2_E = '#/residential-battery-demand-response-eligibility',
  BESS3_E = '#/residential-apartments-battery-eligibility',
